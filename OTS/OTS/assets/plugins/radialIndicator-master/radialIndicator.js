...
;(function (factory) {
    ...
    function Indicator(container, indOption) {
        ...
        function MouseWheelHandler(e) {
            ...
            var delta = -(Math.max(-1, Math.min(1, (e.wheelDelta || -e.detail)))),
                ...
                val = self.current_value + Math.round(precisionNo * delta * diff / Math.min(diff, 10)) / precisionNo;
    ...
    Indicator.prototype = {
        ...
        value: function(val) {
            ...
            var precision = indOption.precision != null ? indOption.precision : 0,
                precisionNo = Math.pow(10, precision),
                perVal = Math.round(((val - minVal) * precisionNo / (maxVal - minVal)) * 10) / precisionNo, //percentage value tp two decimal precision
        ...
        animate: function(val) {
            var indOption = this.indOption,
                ...
                minVal = indOption.minValue,
                maxVal = indOption.maxValue,
                frameNum = indOption.frameNum || (indOption.percentage ? 10 : 500),
    ...
    radialIndicator.defaults = {
        ...
        barColor: '#99CC33', //filled bar color , can be a range also having different colors on different value like {0 : "#ccc", 50 : '#333', 10: '#000'}
        format: null, //format indicator numbers, can be a # formator ex (##,###.##) or a function
        frameTime: 10, //miliseconds to move from one frame to another
        frameNum: null, //Defines numbers of frame in indicator, defaults to 10 when showing percentage and 500 for other values
